...
const Otp: React.FC<OtpProps> = () => {
    ...
    return (
        <div className='w-full flex items-center justify-center rounded-lg shadow-lg shadow-blue-500/50'>
            <div className='w-[400px] min-h-[250px] p-6 flex items-center justify-center'>
